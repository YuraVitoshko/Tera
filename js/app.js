(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".catalog-page__images")) {
                const thumbsSwiper = new core(".images-small__slider", {
                    ...
                    navigation: {
                        prevEl: ".images-small__left-btn",
                        nextEl: ".images-small__right-btn"
                    },
                    on: {}
                });
                new core(".images-big__slider", {
                    modules: [ Navigation, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
